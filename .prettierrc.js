module.exports = {
  ...
  htmlWhitespaceSensitivity: 'css', // css,strict,ignore、デフォルトの設定だとcssだがこれは、要素のデフォルトのdisplayプロパティの値をみてフォーマットするため、cssなどでデフォルトからdisplayを変更したそれを考慮できないためstrictが最善、まぁ、予期せぬ空白が入る場合は、ブロック要素をむ
